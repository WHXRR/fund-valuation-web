...
import { Wallet, List, LogOut, User, LayoutDashboard } from 'lucide-react';
        ...
        <div className="border-t p-4">
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            <div className="flex-1 overflow-hidden">
               <p className="text-sm font-medium truncate text-gray-700 dark:text-gray-200">{user?.email || '未登录'}</p>
            </div>
             {user && (
